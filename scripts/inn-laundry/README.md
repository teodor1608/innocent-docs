...
Eve server-authoritative rule (wash progress, electricity draw, access checks, purchases) is computed and enforced server-side from timestamps and database state — nothing about a wash cycle's outcome is ever trusted from the client.
